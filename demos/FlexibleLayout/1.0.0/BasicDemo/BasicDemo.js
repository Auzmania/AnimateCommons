...
(lib.Dummy = function() {
	this.initialize(img.Dummy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,76,72);// helper functions:
...
(lib.BasicDemo = function(mode,startPosition,loop) {
	...
	this.instance_2 = new lib.Dummy();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,494);
	...
	this.instance_3.setTransform(296.7,73.7,1,1,0,0,0,947.9,59.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// Scenery
	this.instance_4 = new lib.Scenery();
	this.instance_4.parent = this;
	this.instance_4.setTransform(300,231.7,1,1,0,0,0,960,218.2);
	this.instance_4.cache(-2,-2,1924,441);
	...
	this.instance_5.setTransform(837.6,184.2,0.623,0.623,0,0,0,32.9,48.6);

	this.instance_6 = new lib.Windmill();
	this.instance_6.parent = this;
	this.instance_6.setTransform(911,171.6,0.623,0.623,0,0,0,32.9,48.6);

	this.instance_7 = new lib.Windmill();
	this.instance_7.parent = this;
	this.instance_7.setTransform(867.7,155.8,1,1,0,0,0,32.9,48.6);

	this.instance_8 = new lib.Windmill();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-98.3,217.1,1,1,0,0,0,32.9,48.6);
	...
	// WindmillBottom
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A34B31").s().p("AgKAdIABhOIATAAIABBjg");
	this.shape.setTransform(-98.1,209.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Background
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#B7DCE9").s().p("EiV+ANQIAA6fMEr9AAAIAAafg");
	this.shape_1.setTransform(299.9,-67.2,1,2.793);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#CDE5F1").s().p("EiV+AjKMAAAhGTMEr9AAAMAAABGTg");
	this.shape_2.setTransform(299.9,225);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-632.2,-79.1,5631.6,870.1);
// library properties:
lib.properties = {
	width: 600,
	height: 450,
